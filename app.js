...
function isValidCard(cardNumber) {
  do {
    ...
    var cardNumber = prompt('Ingrese el numero de la tarjeta de credito');
    ...
    for (h = 0; h < arrFinal.length; h++) { /* sumo todas las cifras y le calculo el resto */
    	sumTotal += (arrFinal[h] % 10);
    }
